...
$query = "select * from orders where susername = '$username' order by id desc";
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navigation">
				  <ul class="nav navbar-nav">
					...
					<li class="active"><a href="booked-product.php">Booked Product</a></li>
...
<tr align="center">
<th align="center">Product Image</th><th align="center">Product Name</th><th align="center">Rate</th><th align="center">Quantity</th><th align="center">Total</th><th align="center">Order By</th>
</tr>
...
<td> <a href="buyer-details.php?username=<?php echo $rec['username']; ?>"><?php echo $rec['username']; ?> </a></td>
</tr>
<?php } ?>
</table>
			</div>
