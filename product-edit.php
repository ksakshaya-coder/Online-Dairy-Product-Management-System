...
session_start(); 
	if(isset($_REQUEST['btnSubmit'])) 
	{
		...
		$pqw = $_REQUEST['pqw'];
		$id = $_REQUEST['id'];
		$query1 = "update product set pname='$pname',rate='$rate',pqw='$pqw' where id ='$id'";
			...
			<div class="col-md-5 col-md-offset-1">
				<div class="appointment-form">
					...
					<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
						<input type="text" class="col-md-12 col-xs-12 appointment-name" name="pname" placeholder="Product Name" required value="<?php echo $rec['pname']; ?>">
                        
                        <input type="text" class="col-md-12 col-xs-12 appointment-name" name="rate" placeholder="Product Rate" required  onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?php echo $rec['rate']; ?>"/>
