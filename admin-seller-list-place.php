...
$query = "select * from seller where address='$address' order by id desc";
...
<body>
	...
	<section class="blog">
		<div class="container">
            ...
            <form method="post" action="admin-seller-list-place.php">
...
<tr align="center"><th align="center">Client Name</th>
<th align="center">Company Name</th><th align="center">E-Mail</th><th align="center">Mobile</th><th align="center">Address</th><th align="center">Username</th><th align="center">Password</th><th align="center">Status</th><th align="center">Change Status</th>
</tr>
...
<td> <a href="seller-status.php?id=<?php echo $rec['id']; ?>">Edit</a> </td>
</tr>
<?php } ?>
</table> <br><br>
