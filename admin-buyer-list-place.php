...
$query = "select * from buyer where address='$address' order by id desc";
...
<body>
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navigation">
				  <ul class="nav navbar-nav">
					...
					<li class="active"><a href="admin-buyer-list.php">Buyer List</a></li>
	...
	<section class="blog">
		<div class="container">
			<h2>Buyer List</h2>
            <form method="post" action="admin-buyer-list-place.php">
        	<select name="address" required >
                          <option value="" >Select Place</option>         
                            <?php 
                                $sql=mysql_query("SELECT min(id) AS id,address FROM buyer GROUP BY address"); 
...
<tr align="center"><th align="center">Buyer Name</th>
<th align="center">E-Mail</th><th align="center">Mobile</th><th align="center">Address</th><th align="center">Username</th><th align="center">Password</th><th align="center">Status</th><th align="center">Change Status</th>
</tr>
...
<td> <a href="buyer-status.php?id=<?php echo $rec['id']; ?>">Edit</a> </td>
</tr>
<?php } ?>
</table> <br><br>
