...
if(isset($_REQUEST['btnSubmit'])) 
	{
		...
		$query = "insert into buyer (bname,email,mobile,address,username,password,status) values ('$bname','$email','$mobile','$address','$username','$password','$status')";
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navigation">
				  <ul class="nav navbar-nav">
					...
					<li class="active"><a href="buyer-registration.php">Buyer Registration</a></li>
		...
		<div class="container">
			...
			<div class="col-md-5 col-md-offset-1">
				<div class="appointment-form">
					<h3>Buyer Registration</h3><br>
					<form method="post">
						<input type="text" class="col-md-12 col-xs-12 appointment-name" name="bname" placeholder="Your Name" required autofocus/>
